...
public class Lambda_01_Test {
    ...
    public void test_filter_by_age() throws Exception {
        ...
        PersonPredicate ppdct = person -> person.getAge() >= 18;
        
        // TODO result ne doit contenir que des personnes adultes (age >= 18)
        List<Person> result = filter(personList, ppdct);
    ...
    public void test_filter_by_firstname() throws Exception {
        ...
        PersonPredicate ppdct = person -> person.getFirstname().equals("first_10");
    ...
    public void test_filter_by_password() throws Exception {
        ...
        PersonPredicate ppdct = person -> person.getAge() > 49 && DigestUtils.sha512Hex(person.getPassword()).equals(passwordSha512Hex);
